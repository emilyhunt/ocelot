...
def king_number_density(r_values: Union[float, np.ndarray], r_core: float, r_tidal: float, normalise: bool = False):
    """Computes the integrated King surface density (King 1962, equation 18) given the three parameters. Can take
    vectorised input. Will return the number of stars within a distance r of the cluster.
